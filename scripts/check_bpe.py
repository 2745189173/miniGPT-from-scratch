...
def main():
    training_text = ("hello hello world! hello hello transformer! ") * 20
    ...
    assert decoded == test_text, "BPE encode/decode should preserve the original text."
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        loaded_text = loaded_tokenizer.decode(loaded_ids)

        assert loaded_ids == encoded, "Loaded tokenizer should reproduce token ids."
        assert loaded_text == test_text, "Loaded tokenizer should preserve round trips."
